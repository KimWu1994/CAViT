...
class Swin3D(VideoBaseline):
    ...
    def __init__(self, *,
        ...
        super(Swin3D, self).__init__(backbone=backbone,
                                          heads=heads,
    ...
    def preprocess_t_image(self, batched_inputs):
        """
