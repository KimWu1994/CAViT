...
class TemporalRestrictedCrop(object):
    ...
    Args:
        size (int): Desired output size of the crop.
    """
    def __init__(self, size, stride=8):
        self.size = size
...
def build_temporal_transforms(name, size, stride):
    
    if name == 'TemporalBeginCrop':
        trans = TemporalBeginCrop(size, stride)
    
    elif name == 'TemporalRandomCrop':
        trans = TemporalRandomCrop(size, stride)
    
    elif name == 'TemporalRestrictedCrop':
        trans = TemporalRestrictedCrop(size, stride)
    
    elif name == 'TemporalRestrictedBeginCrop':
        trans = TemporalRestrictedBeginCrop(size, stride)
    
    elif name == 'TemporalRestrictedTest':
        trans = TemporalRestrictedTest(size, stride)
